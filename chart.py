...
# 6. Adjust layout and save the chart with exact dimensions
plt.tight_layout()  # Adjust plot to fit within the figure area
plt.savefig('chart.png', dpi=64, pad_inches=0) # <-- FINAL FIX: Remove all padding